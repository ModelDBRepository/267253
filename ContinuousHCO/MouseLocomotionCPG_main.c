...
int main (void) {  
  ...
  int run4 = 1;   //state of the model, changing when equations are changed or when "canonical" parameter 
  ...
  int nvar = 22;  //Number of variables or number of equations
  double yy[nvar]; 
  ...
  FILE * f = fopen("ipContinuousHCO.txt", "r");  //initial condition file
  double number = 0; 
